...
//
//     final charactersSeriesModel = charactersSeriesModelFromJson(jsonString);

import 'dart:convert';

import 'package:marvel_task/presentation/string_manager.dart';

CharactersSeriesModel charactersSeriesModelFromJson(String str) => CharactersSeriesModel.fromJson(json.decode(str));

String charactersSeriesModelToJson(CharactersSeriesModel data) => json.encode(data.toJson());

class CharactersSeriesModel {
    ...
    factory CharactersSeriesModel.fromJson(Map<String, dynamic> json) => CharactersSeriesModel(
        code: json["code"],
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        total: json["total"],
        count: json["count"],
        results: List<SeriesModel>.from(json["results"].map((x) => SeriesModel.fromJson(x))),
    );
