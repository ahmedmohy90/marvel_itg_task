...
//
//     final charactersComicsModel = charactersComicsModelFromJson(jsonString);

import 'dart:convert';

import 'package:marvel_task/presentation/string_manager.dart';

CharactersComicsModel charactersComicsModelFromJson(String str) => CharactersComicsModel.fromJson(json.decode(str));

String charactersComicsModelToJson(CharactersComicsModel data) => json.encode(data.toJson());

class CharactersComicsModel {
    ...
    factory CharactersComicsModel.fromJson(Map<String, dynamic> json) => CharactersComicsModel(
        code: json["code"],
        status: json["status"],
